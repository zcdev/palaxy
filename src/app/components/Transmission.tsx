        ...
        <section className="relative flex flex-col items-center justify-center overflow-hidden bg-transparent text-white text-center w-full p-4 mx-6 my-10 md:mt-0">
            <WavePrismBackground className="w-full bg-transparent mx-auto">
                ...
                <p className="font-body text-lg text-white/70 mt-6 mb-4 max-w-xl">
                    Remember: the Palaxy isn’t far away. It’s the coworker next to you, <br className="hidden sm:block" />the stranger in line, or the friend who’s secretly your opposite cosmic wavelength. Stay curious, keep orbiting, and maybe—just maybe—you’ll meet your neighboring force at the next coffee nebula. See you again!
                </p>
