...
export function Transmission({ responses, onReturn }: Props) {
    ...
    return (
        <section className="flex flex-col items-center justify-center text-white text-center w-full">
            <WavePrismBackground className="w-full mx-auto">
                <div className="px-6">
                    <h1 className="text-3xl md:text-4xl font-headline tracking-wider mb-4">Transmission Complete</h1>
                    ...
                    <p className="font-body text-lg text-white mt-6 mb-4 max-w-xl">
