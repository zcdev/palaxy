    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="modal fixed inset-0 bg-black/60 flex items-center justify-center z-40 px-4"
            >
                <motion.div
                    ...
                    role="dialog"
                    aria-modal="true"
                    className="bg-white/80 p-10 rounded-2xl max-w-lg text-center text-black shadow-lg"
                >
